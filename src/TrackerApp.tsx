    ...
    <div className="app">
        ...
        <>
          ...
          <div style={{ marginTop: '2rem' }}>
            ...
            <SettingsForm
              ...
              onRequestReset={() => setResetDataConfirm(true)}
            />
          </div>
        </>
      )}
      ...
      {resetDataConfirm && (
        <ConfirmDialog
          ...
          message="This clears your training settings, run log, and completed workouts from this browser. You will stay signed in. This cannot be undone."
...
function SettingsForm({
  ...
  return (
    <div style={{ maxWidth: 400 }}>
      ...
      <button type="button" className="btn btn-ghost" onClick={onRequestReset}>
        Reset all data
      </button>
    </div>
  )
